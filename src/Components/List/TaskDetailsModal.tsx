...
const TaskDetailsModal: React.FC<TaskDetailsProps> = () =>
  //   {
  //   taskName,
  //   taskDetails,
  //   taskDueDate,
  //   },
  {
    ...
    //   const [details, setDetails] = useState<string>(taskDetails);
    ...
    return (
      ...
      >
        ...
        >
          <h1 className="text-xl font-semibold text-slate-200">Edit Task</h1>
